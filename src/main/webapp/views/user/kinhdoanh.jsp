...
<body>
	...
	<section>
		<div class="row_1 boxcenter_1">
			...
			<div class="col_right right_1">
				<a href="#"><img src="/Assignment_NVC/image/bannerkinhdoanh.png" alt="" /></a>
			</div>
		</div>
	</section>
	<!-- section 2 -->
	<section>
		<div class="row_2 boxcenter_2">
			<div class="left_2_pl">
				<c:forEach var="news" items="${kdnewsList}" varStatus="status">
					<c:if test="${status.index >= 4 && status.index <= 10}">
			...
			<div class="main-container-wrapper">
				<div class="main-container">
					...
					<div class="right-container">
						<div class="sub-article">
							<c:forEach var="news" items="${kdnewsList}" varStatus="status">
								<c:if test="${status.index >= 13 && status.index <= 14}">
									<div class="sub-title">
										<a
											href="${pageContext.request.contextPath}/chitiet/asm?id=${news.id}">
											${news.title} </a>
				...
				<div class="main-container">
					...
					<div class="right-container">
						<div class="sub-article">
							<c:forEach var="news" items="${kdnewsList}" varStatus="status">
								<c:if test="${status.index >= 17 && status.index <= 18}">
									<div class="sub-title">
										<a
											href="${pageContext.request.contextPath}/chitiet/asm?id=${news.id}">
											${news.title} </a>
				...
				<div class="main-container">
					...
					<div class="right-container">
						<div class="sub-article">
							<c:forEach var="news" items="${kdnewsList}" varStatus="status">
								<c:if test="${status.index >= 21 && status.index <= 22}">
									<div class="sub-title">
										<a
											href="${pageContext.request.contextPath}/chitiet/asm?id=${news.id}">
											${news.title} </a>
				...
				<div class="main-container">
					...
					<div class="right-container">
						<div class="sub-article">
							<c:forEach var="news" items="${kdnewsList}" varStatus="status">
								<c:if test="${status.index >= 25 && status.index <= 26}">
									<div class="sub-title">
										<a
											href="${pageContext.request.contextPath}/chitiet/asm?id=${news.id}">
											${news.title} </a>
